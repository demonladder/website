        ...
        <main>
            ...
            <div className='text-lg'>
                ...
                <div className='mt-4'>
                    ...
                    <div>
                        <button onClick={() => app.set('levelViewType', LevelViewType.LIST)} className={'w-1/2 hover:bg-theme-500 py-3 transition-colors ' + (app.levelViewType === LevelViewType.LIST ? 'bg-theme-600 border-b' : 'bg-theme-700')}>List</button>
                        <button onClick={() => app.set('levelViewType', LevelViewType.GRID)} className={'w-1/2 hover:bg-theme-500 py-3 transition-colors ' + (app.levelViewType === LevelViewType.GRID ? 'bg-theme-600 border-b' : 'bg-theme-700')}>Grid</button>
                    </div>

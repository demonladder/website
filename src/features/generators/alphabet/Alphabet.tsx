...
export default function Alphabet() {
    ...
    return (
        <div>
            ...
            <p>
                You get one level for every letter in the alphabet. It should be completed in alphabetical order but
            ...
            <div>
                <FormGroup>
                    ...
                    <NumberInput
                        value={minTier.value}
                        onChange={(e) => minTier.setValue(e.target.value)}
                        id='minTier'
                        min='1'
                        max={MAX_TIER}
                    ...
                    <FormInputDescription>
                        Optional. The lowest tier of the alphabet. Use decimals for higher precision.
                    </FormInputDescription>
                </FormGroup>
                <FormGroup>
                    ...
                    />
                    <FormInputDescription>
                        Optional. The highest tier of the alphabet. Use decimals for higher precision.
                    </FormInputDescription>
                </FormGroup>
                <FormGroup>
                    ...
                    />
                    <FormInputDescription>
                        Optional. The lowest enjoyment of the alphabet. Use decimals for higher precision.
                    </FormInputDescription>
                </FormGroup>
                <FormGroup>
                    ...
                    />
                    <FormInputDescription>
                        Optional. The highest enjoyment of the alphabet. Use decimals for higher precision.
                    </FormInputDescription>
                </FormGroup>
                <FormGroup>
                ...
                <FormGroup>
                    ...
                    <FormInputDescription>
                        Optional. Only include levels that you have not completed.
                    </FormInputDescription>
                </FormGroup>

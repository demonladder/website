...
export default function Login() {
    ...
    const { mutate: submit, isPending } = useMutation({
        mutationFn: ({
            ...
            toast.promise(accountLogin(username, password, challenge, totpCode), {
                pending: 'Logging in...',
                success: 'Logged in!',
        ...
        onError(error: AxiosError<GDDLError>) {
            ...
            if (
                ...
                /TOTP.*required/.test(error.response.data.message)
            ) {
        ...
        <Page>
            <div className='flex justify-center'>
                <form className='w-11/12 md:w-1/2 lg:w-2/6' onSubmit={handleSubmit}>
                    ...
                    <PrimaryButton type='submit' className='relative mt-4 w-full' loading={isPending}>
                        Log in
                    </PrimaryButton>
                    <div className='mt-8'>

        ...
        <div className='mt-6'>
            <div className='flex items-center gap-2 mb-2 flex-wrap'>
                ...
                <div className='flex items-center'>
                    {!hide && <>
                        <button className={'text-black w-7 h-7 grid place-items-center ' + (listType === EListType.inline ? 'bg-theme-950 text-theme-text' : 'bg-theme-500')} onClick={() => setListType(EListType.inline)}>
                        ...
                        <button className={'text-black w-7 h-7 grid place-items-center ' + (listType === EListType.grid ? 'bg-theme-950 text-theme-text' : 'bg-theme-500')} onClick={() => setListType(EListType.grid)}>

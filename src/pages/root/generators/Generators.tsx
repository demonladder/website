...
export default function Generators() {
    return (
        <Container>
            ...
            <div className='grid gap-2 grid-cols-5 my-8 text-xl'>
                ...
                <NavLink to='reverseRoulette' className={({ isActive }) => `p-2 text-center bg-gray-${isActive ? 600 : 700}`}>Reverse roulette</NavLink>

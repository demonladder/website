...
import GenerateAlphabet from '../../../../api/alphabet/GenerateAlphabet';
    ...
    return (
        <div>
            ...
            {generateMutation.data &&
                <ol className='mt-4 text-xl'>{generateMutation.data.map((l) => (
                    <li className='flex even:bg-gray-700' key={l.ID}>
                        <p className='ps-2 py-1 grow'>{l.Name}</p>

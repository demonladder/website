...
export default function EditSubmission() {
    ...
    const { status, data } = useQuery({
        queryKey: ['level', activeLevel?.ID, 'submissions', { page, username, progressFilterKey: 'all' }],
        queryFn: () => getLevelSubmissions({ levelID: activeLevel?.ID || 0, limit: 24, page, username, progressFilter: 'all' }),
    });
    ...
    useEffect(() => {
        ...
        setUserID(undefined);
    }, [activeLevel, setLevelID, setPage, setUserID]);
        ...
        <main>
            ...
            <div className='flex flex-col gap-4'>
                ...
                <div>
                    ...
                    <TextInput value={username} onChange={(e) => setUsername(e.target.value)} placeholder='Filter by user name...' />

...
export default function useLevelView(storageKey: string): [boolean, JSX.Element] {
    ...
    return [
        ...
        (<div className='flex items-center text-black'>
            <button className={'w-7 h-7 grid place-items-center ' + (isList ? 'bg-theme-950' : 'bg-theme-500')} onClick={onViewList}>
            ...
            <button className={'w-7 h-7 grid place-items-center ' + (!isList ? 'bg-theme-950' : 'bg-theme-500')} onClick={onViewGrid}>

    ...
    return [
        ...
        (<div>
            <span className='inline-block text-theme-text p-1 bg-theme-700 rounded-md'>
                <button className={'p-2 rounded-md me-1 transition-colors ' + (isList ? 'bg-theme-950' : '')} onClick={onViewList}>
                ...
                <button className={'p-2 rounded-md transition-colors ' + (!isList ? 'bg-theme-950' : '')} onClick={onViewGrid}>

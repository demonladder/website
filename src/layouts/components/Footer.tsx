            ...
            <div className='mx-auto container grid grid-cols-1 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 max-lg:px-10 gap-8'>
                <div>
                    ...
                    <ul className='text-2xl flex gap-2'>
                        <li>
                            <a href='https://www.youtube.com/channel/UCp51CBBbdNJBAlGLTPZEPgw' target='_blank' rel='noopener noreferrer'><i className='bx bxl-youtube' /></a>
                        </li>
                        <li>
                            <a href='https://twitter.com/gdladder' target='_blank' rel='noopener noreferrer'><i className='bx bxl-twitter'></i></a>
                        </li>
                        <li>
                            <a href='https://discord.gg/gddl' target='_blank' rel='noopener noreferrer'><i className='bx bxl-discord-alt' /></a>
                        </li>
                    </ul>
                </div>
                <div>
                ...
                <div>
                    ...
                    <ul className='flex flex-col gap-1'>
                        <BlankAnchor href='https://discord.com/channels/741568423485767721/1097178580158529547'>Discord support forum</BlankAnchor>
                    </ul>
                </div>
                <div>
                ...
                <div className='text-sm'>
                    ...
                    <p><a className='font-bold' property='dct:title' rel='cc:attributionURL' href='https://gdladder.com/'>GDDLadder</a> by <a className='font-bold' rel='cc:attributionURL dct:creator' property='cc:attributionName' href='https://github.com/DiversenSato'>Diversion</a> is licensed under <a className='font-bold inline-block' href='http://creativecommons.org/licenses/by-nc-sa/4.0/' target='_blank' rel='license noopener noreferrer'>Attribution-NonCommercial-ShareAlike 4.0 International<img width='20' height='20' className='ml-1 align-text-bottom inline-block' src='https://mirrors.creativecommons.org/presskit/icons/cc.svg' /><img width='20' height='20' className='ml-1 align-text-bottom inline-block' src='https://mirrors.creativecommons.org/presskit/icons/by.svg' /><img width='20' height='20' className='ml-1 align-text-bottom inline-block' src='https://mirrors.creativecommons.org/presskit/icons/nc.svg' /><img width='20' height='20' className='ml-1 align-text-bottom inline-block' src='https://mirrors.creativecommons.org/presskit/icons/sa.svg' /></a></p>
                </div>
            </div>
        </footer>
    );

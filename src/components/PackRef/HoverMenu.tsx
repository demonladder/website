...
export default function HoverMenu({ averageEnjoyment, levelCount, medianTier }: Props) {
    return (
        <div className='absolute pointer-events-none opacity-0 group-hover:opacity-100 transition-all text-center top-full left-1/2 -translate-x-1/2 -translate-y-2 group-hover:translate-y-1 z-10 bg-theme-500 border border-theme-400 p-2 round:rounded-lg shadow-xl'>
            <ul>
                <li>

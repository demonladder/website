...
export function useSubmission(levelID: number, userID: number | undefined, options: UseQueryOptionsWithoutKey<Awaited<ReturnType<typeof GetSingleSubmission>>, AxiosError>) {
    return useQuery({
        ...options,

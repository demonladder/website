        ...
        <Modal title='Sync Discord account' show={true} onClose={close}>
            <div>
                <div className='my-6'>
                    ...
                    <p>This also adds your current profile picture to gddl, and you will be able to receive DMs on Discord when your submissions get approved (should you choose it).</p>
                    <DiscordLink className='my-4' href={import.meta.env.VITE_DISCORD_OAUTH}>Sync to Discord</DiscordLink>
                    <p>You can always sync in <a href='/settings/profile' className='text-blue-400 underline' target='_blank' rel='noopener noreferrer'>profile settings</a> if you change your pfp and want it to show.</p>
                </div>
            </div>
            <div>

        ...
        <Modal title='Sync Discord account' show={true} onClose={close}>
            <Modal.Body>
                <div className='my-6'>
                    ...
                    <p>This is mostly a security measure, but it also adds your current profile picture to gddl, and you will be able to receive DMs on Discord when your submissions gets approved, should you choose it.</p>

...
export default function Notifications() {
    ...
    function openNotifications() {
        ...
        setShow(true);
        MarkReadNotifications(data.slice(0, 5).filter((notif) => !notif.IsRead).map((notif) => notif.ID));
    }
    ...
    return (
        <div className='cursor-pointer relative'>
            ...
            <div className={'absolute w-72 left-1/2 -translate-x-1/2 bg-gray-500 text-white round:rounded-lg transition-opacity ' + (show ? 'opacity-100' : 'opacity-0')}>

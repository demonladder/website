export default function ProfileTypeIcon({ permissionLevel }: { permissionLevel: number }) {
    switch(permissionLevel) {
        ...
        case 5: return <span className='m-0 cursor-help' title='Co-Owner' role='img' aria-label='Role icon'>🎖️</span>;
        case 6: return <span className='m-0 cursor-help' title='Owner' role='img' aria-label='Role icon'>⭐</span>;
        default: return;
    }
}
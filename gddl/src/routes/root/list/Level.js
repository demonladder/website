...
export default function Level({ info, creatorLink }) {
    return (
        <div className='row level'>
            ...
            <div className='col-2 align-self-center'><Creator name={info.Creator} callback={creatorLink} disableLink={info.isHeader} /></div>
